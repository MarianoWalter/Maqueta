	...
	<div id="app">
		...
		<div class="container-fluid">
			...
			<Carousel
				:navigation="true"
				:items="[
					{ text: 'Redefiniendo la experiencia del cliente', sub: 'en las salas de espera' },
					{ text: 'Segundo texto de ejemplo', sub: 'para ver cómo queda' },
					{ text: 'Otro texto más', sub: 'para testing' },
				]"
			></Carousel>
